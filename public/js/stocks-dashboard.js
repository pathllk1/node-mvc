      ...
      <div class="bg-gradient-to-r from-cyan-50 to-sky-50 rounded-xl p-6 border border-cyan-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div class="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <p class="text-lg font-bold ${taData.indicators.macd.color}">${formatValue(taData.indicators.macdSignal)}</p>
            <p class="text-xs ${taData.indicators.macd.color}">${taData.indicators.macd.signal}</p>
          <div class="bg-white p-4 rounded-lg border border-gray-200">
            <p class="text-sm text-gray-500">MACD Histogram</p>
            <p class="text-lg font-bold ${taData.indicators.macd.color}">${formatValue(taData.indicators.macdHist)}</p>
            <p class="text-xs ${taData.indicators.macd.color}">${taData.indicators.macd.signal}</p>
          <div class="bg-white p-4 rounded-lg border border-gray-200">
    ...
    button.addEventListener('click', async function() {
      ...
      try {
        ...
        if (response.ok && taCharts.price) {
          ...
          taCharts.price.data.datasets[0].data = timeSeriesData;
          taCharts.price.update();
        }
      } catch (error) {
